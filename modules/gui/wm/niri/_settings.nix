{ self }: {
  ...
  # }
  overview = { backdrop-color = self.theme.base02; };
  layer-rules = [{
  ...
  layout = {
    ...
    insert-hint = { color = self.theme.base0D; };
    border.off = _: { };
  ...
  binds = {
    "Mod+D" = { spawn = "fuzzel"; };
    "Super+Shift+Alt+L" = { spawn-sh = "loginctl lock-session"; };
    "Mod+P" = { spawn-sh = "makoctl dismiss -a"; };
    "Mod+Shift+P" = { spawn-sh = "makoctl restore"; };
